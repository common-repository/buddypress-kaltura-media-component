...
//        $this->pic_mid_path_act = $picture->dataUrl;
        $this->pic_org_path = $picture->downloadUrl;
        $this->pic_org_path_act = $picture->downloadUrl;
        $this->pic_mid_path = $picture->downloadUrl;
        $this->pic_mid_path_act = $picture->downloadUrl;
